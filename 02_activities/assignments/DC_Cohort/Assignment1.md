...
```
The paper "When Databases Define Family" reveals how technical systems encode social and political biases during the design process by using Pakistan's national database NADRA as a case study. Using this digital identity system, every citizen must register as being a member of a "family unit," with the default assumption being that a family is made up of two legitimate parents and a married heterosexual couple. This reflects the state's social judgment about "what constitutes a normal family" and "who qualifies as a citizen," demonstrating that databases don't simply reflect social reality—they actively determine who is seen and who is excluded through their schema architecture.
This made me think about who designs databases. Take, for example, my current construction company. The company has built an internal database for each employee to track and display professional qualifications, such as automatically displaying construction-related professional certifications (like OAA and LEED) in email signatures. On the surface, this is an organizational management and knowledge visualization system; but at a deeper level, it also implicitly defines "what knowledge and qualifications are valuable." The database's creators are actually perpetuating the traditional thinking of the construction industry: it recognizes "formal" and "traditional" professional certifications but leaves no room for emerging skills, such as cross-disciplinary innovation, AI design tools, educational design, or sustainable social innovation. These capabilities, while potentially closer to the future direction of the industry, become "invisible" due to the database's structure.
People who design databases use their own frameworks/worldview to define fields, define relationships, and establish rules to define "the limits of reality." Who designs the database has a great deal to do with its biases. When only those with the power to "build databases" can determine data structures, their inherent biases become written into the system logic, and these biases often cause marginalized people to remain marginalized.
This also led me to reflect on my own PhD project, which will inevitably involve database components. How to minimize these stereotypes may be crucial groundwork before using or building databases. Critical thinking and empathy are two feasible approaches I can currently envision. For instance, if I need to establish a database of my project users, could I conduct a more detailed analysis of each user's profile before building the database and verify these profiles with them? As new technologies emerge, we must maintain ongoing critical thinking about each decision we make, so that technology can better serve us.
